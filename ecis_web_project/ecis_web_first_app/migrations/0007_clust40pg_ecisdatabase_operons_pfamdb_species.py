# Generated by Django 3.0.3 on 2020-08-02 16:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ecis_web_first_app', '0006_auto_20200802_1929'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EcisDataBase',
            fields=[
                ('genome_ID_x', models.CharField(max_length=264)),
                ...
                ('pfam_query_start', models.CharField(max_length=264)),
                ('pfam_query_end', models.CharField(max_length=264)),
                ...
                ('pfam_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecis_web_first_app.PfamDb')),
            ],
        ),
    ]
